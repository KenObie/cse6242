...
def author():                                                                                             
        return "kobrien43" # replace gburdell3 with your Georgia Tech username.                                                                                             
                                                                                              
def gtid():                                                                                               
    return 903659338 # replace with your GT ID number      
...
class PageRank:
    ...
    def run_pagerank(self, node_weights,  damping_factor=0.85, iterations=10):
        ...
        #############################################
            ...
            # pr_values = np.add(new_pr_values, (1-damping_factor)*node_weights)

            for idx in range(self.max_node_id + 1):
                pr = (1 - damping_factor) * node_weights[idx]
                new_pr_values[idx] += pr
        
        return new_pr_values
